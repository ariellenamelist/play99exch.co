...
import WhatisPlay99Exch from "./components/whatisPlay99Exch/whatisPlay99Exch";
import Whychooseus from "./components/whychooseus/whychooseus";
import Promotionbonuses from "./components/promotion-bonuses/promotion-bonuses";
import Play99ExchOther from "./components/Play99Exch-vs-Other/Play99Exch-vs-Other";
...
export default function Home() {
  ...
  return (
    ...
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
    {
      ...
      "description": "There is no doubt that Play99Exch is the largest gaming website in the world. More than 4500+ sports games are available daily on Play99Exch.com website. Instant deposit and withdrawal. Best odds, 24/7 customer support and referral bonuses. Sign up for a Play99Exch account now.",
      "publisher": {
        "@type": "Organization",
        "name": "Welcome to Play99Exch",
        "url": "https://www.play99exch.co/"
